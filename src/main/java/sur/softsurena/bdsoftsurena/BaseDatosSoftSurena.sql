...
(
  ...
  CONSTRAINT INTEG_44 PRIMARY KEY (ID)
);
...
(
  ...
  ESTADO D_BOOLEAN_T,
  IDUSUARIO D_IDUSUARIO,
  CONSTRAINT INTEG_116 PRIMARY KEY (ID)
);
...
ALTER TABLE ESTUDIANTE ADD CONSTRAINT FK_ESTUDIANTE_0
  FOREIGN KEY (ID_PADRE) REFERENCES PADRES (ID) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ESTUDIANTE ADD CONSTRAINT FK_ESTUDIANTE_1
  FOREIGN KEY (ID) REFERENCES PERSONAS (ID);
ALTER TABLE ESTUDIANTE ADD CONSTRAINT FK_ESTUDIANTE_2
  FOREIGN KEY (ID_MADRE) REFERENCES PADRES (ID) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ESTUDIANTE ADD CONSTRAINT FK_ESTUDIANTE_3
  FOREIGN KEY (ID_TUTOR) REFERENCES PERSONAS (ID) ON UPDATE CASCADE ON DELETE CASCADE;
