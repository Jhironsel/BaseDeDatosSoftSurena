...
CREATE TABLE D_FACTURA_DIRECIONES
(
  ID_FACTURA D_ID DEFAULT 0 NOT NULL,
  ID_DIRECCION D_ID DEFAULT 0 NOT NULL,
  CONSTRAINT D_FACTURA_DIRECIONES_PK PRIMARY KEY (ID_FACTURA,ID_DIRECCION)
);
CREATE TABLE D_FACTURA_EMAILS
(
  ID_FACTURA D_ID NOT NULL,
  ID_CONTACTOS_EMAIL D_ID NOT NULL,
  CONSTRAINT D_FACTURA_EMAILS_PK PRIMARY KEY (ID_FACTURA,ID_CONTACTOS_EMAIL)
);
CREATE TABLE D_FACTURA_TELS
(
  ID_FACTURA D_ID NOT NULL,
  ID_CONTACTOS_TEL D_ID NOT NULL,
  CONSTRAINT D_FACTURA_TELS_PK PRIMARY KEY (ID_FACTURA,ID_CONTACTOS_TEL)
);
...
CREATE VIEW GET_TEMPORALES (ID_FACTURA, NOMBRE_TEMP, PNOMBRE, SNOMBRE, 
     APELLIDOS, IDUSUARIO, ID_TURNO, EFECTIVO, CAMBIO, FECHA_HORA, 
...
FROM D_FACTURAS r;
CREATE VIEW V_D_FACTURA_DIRECCIONES (ID_FACTURA, ID_DIRECCION)
AS SELECT ID_FACTURA, ID_DIRECCION
FROM D_FACTURA_DIRECIONES;
CREATE VIEW V_D_FACTURA_EMAILS (ID_FACTURA, ID_CONTACTOS_EMAIL)
AS SELECT ID_FACTURA, ID_CONTACTOS_EMAIL
FROM D_FACTURA_EMAILS;
CREATE VIEW V_D_FACTURA_TELS (ID_FACTURA, ID_CONTACTOS_TEL)
AS SELECT ID_FACTURA, ID_CONTACTOS_TEL
FROM D_FACTURA_TELS;
...
FROM ESTUDIANTE r;
CREATE VIEW V_E_S_SYS (ID_E_S_SYS, NOMBRE, TELEFONOS, FCHI, FCHA, FCHV, IDMAC, 
     DIRECCION, MENSAJE_FOOTER, LOGO)
AS SELECT ID_E_S_SYS, NOMBRE, TELEFONOS, FCHI, FCHA, FCHV, IDMAC,
     DIRECCION, MENSAJE_FOOTER, LOGO
FROM E_S_SYS;
CREATE VIEW V_FACTURAS (ID, ID_CLIENTE, ID_TURNO, FECHA_HORA, TOTAL, EFECTIVO, 
     CAMBIO, ESTADO_FACTURA, IDUSUARIO, NOMBRE_TEMP)
AS SELECT r.ID, r.ID_CLIENTE, r.IDTURNO, r.FECHA_HORA, r.TOTAL, r.EFECTIVO,
     r.CAMBIO, r.ESTADO_FACTURA, r.IDUSUARIO, r.NOMBRE_TEMP
FROM FACTURAS r;
...
CREATE VIEW V_INSCRIPCION (ID, ID_ESTUDIANTE, ID_TANDA, PAGO, 
     FECHA_INSCRIPCION, ID_USUARIO, ROL)
...
ALTER TABLE D_FACTURAS ADD CONSTRAINT FK_D_FACTURAS_1
  FOREIGN KEY (ID_FACTURA) REFERENCES FACTURAS (ID);
COMMENT ON COLUMN D_FACTURA_DIRECIONES.ID_FACTURA IS 'Es el campo de la factura creada. ';
COMMENT ON COLUMN D_FACTURA_DIRECIONES.ID_DIRECCION IS 'Es el campo de la direccion del cliente que existe en direcciones y que en ese momento estaba activa.';
ALTER TABLE D_FACTURA_DIRECIONES ADD CONSTRAINT FK_D_FACTURA_DIRECIONES_0
  FOREIGN KEY (ID_FACTURA) REFERENCES FACTURAS (ID) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE D_FACTURA_DIRECIONES ADD CONSTRAINT FK_D_FACTURA_DIRECIONES_1
  FOREIGN KEY (ID_DIRECCION) REFERENCES DIRECCIONES (ID) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON TABLE D_FACTURA_DIRECIONES IS 'En esta tabla se almacenan las direcciones de los clientes de las facturas que se realiza el sistema.';
ALTER TABLE D_FACTURA_EMAILS ADD CONSTRAINT FK_D_FACTURA_EMAILS_0
  FOREIGN KEY (ID_FACTURA) REFERENCES FACTURAS (ID);
ALTER TABLE D_FACTURA_EMAILS ADD CONSTRAINT FK_D_FACTURA_EMAILS_1
  FOREIGN KEY (ID_CONTACTOS_EMAIL) REFERENCES CONTACTOS_EMAIL (ID);
ALTER TABLE D_FACTURA_TELS ADD CONSTRAINT FK_D_FACTURA_TELS_0
  FOREIGN KEY (ID_FACTURA) REFERENCES FACTURAS (ID);
ALTER TABLE D_FACTURA_TELS ADD CONSTRAINT FK_D_FACTURA_TELS_1
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_FACTURA_DIRECIONES TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_FACTURA_DIRECIONES TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_FACTURA_EMAILS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_FACTURA_EMAILS TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_FACTURA_TELS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON D_FACTURA_TELS TO  SYSDBA WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_D_FACTURA_DIRECCIONES TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_D_FACTURA_DIRECCIONES TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_D_FACTURA_EMAILS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_D_FACTURA_EMAILS TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_D_FACTURA_TELS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_D_FACTURA_TELS TO  SYSDBA WITH GRANT OPTION;
