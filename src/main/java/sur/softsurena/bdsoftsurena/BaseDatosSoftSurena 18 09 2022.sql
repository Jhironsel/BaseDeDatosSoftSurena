...
CREATE SEQUENCE G_ID_ARS START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE G_ID_CATEGORIAS START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE G_ID_CONTACTOS START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE G_ID_DIRECCIONES START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE G_ID_FACTURA START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE G_ID_PERSONA START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE G_ID_PRODUCTOS START WITH 1 INCREMENT BY 1;
/******************** DOMAINS *********************/
...
(
  ...
  CLIENTE_MODIFICAR_CEDULA D_BOOLEAN_F NOT NULL,
  ...
  USUARIO_CAMBIO_CLAVE D_BOOLEAN_F NOT NULL,
  ...
  CONSTRAINT UNQ_PERFILES_0 UNIQUE (USERNAME)
);
