...
/*
     Ofrece informacion de los roles de los usuarios que tienen asignado en el sistema.
*/;
...
BEGIN
     ...
     /*Al crear un usuario se le da acceso a la base de datos.*/
     EXECUTE STATEMENT 'GRANT SELECT ON GET_ROL TO '||:I_USER_NAME||';';
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON GET_CAJEROS_DISPONIBLES TO ROLE RDB$ADMIN WITH GRANT OPTION;
