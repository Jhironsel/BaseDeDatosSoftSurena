...
*/;
CREATE VIEW GET_ROLES_PERMISOS (USUARIO, GRANT_OPTION, RELATION_NAME)
AS SELECT r.RDB$USER, r.RDB$GRANT_OPTION, r.RDB$RELATION_NAME
...
SET TERM ^ ;
ALTER PROCEDURE SP_CREATE_ROLE (
    I_ROLE D_ROL )
SQL SECURITY DEFINER
...
BEGIN
     ...
     EXECUTE PROCEDURE SP_RECCOUNT_ESTADO('D', 'V_ARS', :v_estado);
...
GRANT PRUEBA TO JHADIEL WITH ADMIN OPTION;
GRANT PRUEBA TO JHIRONSEL;
...
GRANT EXECUTE
 ON PROCEDURE SP_CREATE_ROLE TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_DELETE_ARS TO ROLE PRUEBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_PRODUCTO TO ROLE CAJERO;
...
GRANT EXECUTE
 ON PROCEDURE SP_RECCOUNT TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_RECCOUNT_ESTADO TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_SELECT_GET_CLIENTES_SB TO ROLE CAJERO;
...
GRANT EXECUTE
 ON PROCEDURE SP_SELECT_PRODUCTOS TO ROLE CAJERO;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON GET_ROLES_PERMISOS TO  SYSDBA WITH GRANT OPTION;
