...
SET TERM ^ ;
CREATE PROCEDURE SP_GET_CATEGORIA_ACTIVAS
RETURNS (
    ID TYPE OF COLUMN GET_CATEGORIA_ACTIVAS.ID,
    DESCRIPCION TYPE OF COLUMN GET_CATEGORIA_ACTIVAS.DESCRIPCION,
    IMAGEN_TEXTO TYPE OF COLUMN GET_CATEGORIA_ACTIVAS.IMAGEN_TEXTO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_GET_CLIENTES_SB
RETURNS (
    ID TYPE OF COLUMN GET_CLIENTES_SB.ID,
    CEDULA TYPE OF COLUMN GET_CLIENTES_SB.CEDULA,
    PERSONA TYPE OF COLUMN GET_CLIENTES_SB.PERSONA,
    PNOMBRE TYPE OF COLUMN GET_CLIENTES_SB.PNOMBRE,
    SNOMBRE TYPE OF COLUMN GET_CLIENTES_SB.SNOMBRE,
    APELLIDOS TYPE OF COLUMN GET_CLIENTES_SB.APELLIDOS,
    SEXO TYPE OF COLUMN GET_CLIENTES_SB.SEXO,
    FECHA_NACIMIENTO TYPE OF COLUMN GET_CLIENTES_SB.FECHA_NACIMIENTO,
    ESTADO_CIVIL TYPE OF COLUMN GET_CLIENTES_SB.ESTADO_CIVIL,
    FECHA_INGRESO TYPE OF COLUMN GET_CLIENTES_SB.FECHA_INGRESO,
    ESTADO TYPE OF COLUMN GET_CLIENTES_SB.ESTADO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_PRODUCTOS_FIND
RETURNS (
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_ANALISIS
RETURNS (
    ID TYPE OF COLUMN V_ANALISIS.ID,
    ID_PACIENTE TYPE OF COLUMN V_ANALISIS.ID_PACIENTE,
    FECHA_HORA_CREADA TYPE OF COLUMN V_ANALISIS.FECHA_HORA_CREADA,
    FECHA_HORA_VISTA TYPE OF COLUMN V_ANALISIS.FECHA_HORA_VISTA,
    T_BHCG TYPE OF COLUMN V_ANALISIS.T_BHCG,
    T_EMB_ORINA TYPE OF COLUMN V_ANALISIS.T_EMB_ORINA,
    T_EMB_SANGRE TYPE OF COLUMN V_ANALISIS.T_EMB_SANGRE,
    T_ANT_AUSTRALIANO_BBSAG TYPE OF COLUMN V_ANALISIS.T_ANT_AUSTRALIANO_BBSAG,
    T_CLAMIDIA_IGA TYPE OF COLUMN V_ANALISIS.T_CLAMIDIA_IGA,
    T_FTA_ABS TYPE OF COLUMN V_ANALISIS.T_FTA_ABS,
    T_HIV TYPE OF COLUMN V_ANALISIS.T_HIV,
    T_VDRL TYPE OF COLUMN V_ANALISIS.T_VDRL,
    T_ACIDO_URICO TYPE OF COLUMN V_ANALISIS.T_ACIDO_URICO,
    T_ANT_FEBRILES TYPE OF COLUMN V_ANALISIS.T_ANT_FEBRILES,
    T_ASO_LATEX TYPE OF COLUMN V_ANALISIS.T_ASO_LATEX,
    T_BILIRRUBINA TYPE OF COLUMN V_ANALISIS.T_BILIRRUBINA,
    T_COLESTEROL_TOTAL TYPE OF COLUMN V_ANALISIS.T_COLESTEROL_TOTAL,
    T_COLESTEROL_HDL TYPE OF COLUMN V_ANALISIS.T_COLESTEROL_HDL,
    T_COLESTEROL_HDL_LDL TYPE OF COLUMN V_ANALISIS.T_COLESTEROL_HDL_LDL,
    T_COPROLOGICO TYPE OF COLUMN V_ANALISIS.T_COPROLOGICO,
    T_CREATININA_SUERO TYPE OF COLUMN V_ANALISIS.T_CREATININA_SUERO,
    T_CULTIVO_FARINGE TYPE OF COLUMN V_ANALISIS.T_CULTIVO_FARINGE,
    T_CULTIVO_HECES TYPE OF COLUMN V_ANALISIS.T_CULTIVO_HECES,
    T_CULTIVO_HERIDA_AEROBICO TYPE OF COLUMN V_ANALISIS.T_CULTIVO_HERIDA_AEROBICO,
    T_CULTIVO_OIDO TYPE OF COLUMN V_ANALISIS.T_CULTIVO_OIDO,
    T_CULTIVO_SANGRE TYPE OF COLUMN V_ANALISIS.T_CULTIVO_SANGRE,
    T_CULTIVO_SEMEN TYPE OF COLUMN V_ANALISIS.T_CULTIVO_SEMEN,
    T_CULTIVO_URETRA TYPE OF COLUMN V_ANALISIS.T_CULTIVO_URETRA,
    T_CULTIVO_VAGINA TYPE OF COLUMN V_ANALISIS.T_CULTIVO_VAGINA,
    T_ELECTRO_HEMOGLOBINA TYPE OF COLUMN V_ANALISIS.T_ELECTRO_HEMOGLOBINA,
    T_ERITROSEDIMENTACION TYPE OF COLUMN V_ANALISIS.T_ERITROSEDIMENTACION,
    T_ESPERMATOGRAMA TYPE OF COLUMN V_ANALISIS.T_ESPERMATOGRAMA,
    T_ESTRADIOL TYPE OF COLUMN V_ANALISIS.T_ESTRADIOL,
    T_ESTROGENO_TOTALES TYPE OF COLUMN V_ANALISIS.T_ESTROGENO_TOTALES,
    T_FACTOR_REUMATOIDE TYPE OF COLUMN V_ANALISIS.T_FACTOR_REUMATOIDE,
    T_FALCEMIA TYPE OF COLUMN V_ANALISIS.T_FALCEMIA,
    T_FOSFATASA_ALCALINA TYPE OF COLUMN V_ANALISIS.T_FOSFATASA_ALCALINA,
    T_FSH TYPE OF COLUMN V_ANALISIS.T_FSH,
    T_GLICEMIA TYPE OF COLUMN V_ANALISIS.T_GLICEMIA,
    T_HEMOGLO_GLUCOSILADA TYPE OF COLUMN V_ANALISIS.T_HEMOGLO_GLUCOSILADA,
    T_HEMOGRAMA TYPE OF COLUMN V_ANALISIS.T_HEMOGRAMA,
    T_HEPATITIS_A TYPE OF COLUMN V_ANALISIS.T_HEPATITIS_A,
    T_HEPATITIS_C TYPE OF COLUMN V_ANALISIS.T_HEPATITIS_C,
    T_KOH TYPE OF COLUMN V_ANALISIS.T_KOH,
    T_LH TYPE OF COLUMN V_ANALISIS.T_LH,
    T_ORINA TYPE OF COLUMN V_ANALISIS.T_ORINA,
    T_PCR TYPE OF COLUMN V_ANALISIS.T_PCR,
    T_PROGESTERONA TYPE OF COLUMN V_ANALISIS.T_PROGESTERONA,
    T_PROLACTINA TYPE OF COLUMN V_ANALISIS.T_PROLACTINA,
    T_PROTEINAS_TOTALES TYPE OF COLUMN V_ANALISIS.T_PROTEINAS_TOTALES,
    T_PSA_TOTAL TYPE OF COLUMN V_ANALISIS.T_PSA_TOTAL,
    T_PSA_LIBRE TYPE OF COLUMN V_ANALISIS.T_PSA_LIBRE,
    T_SANG_OCULT_HECES TYPE OF COLUMN V_ANALISIS.T_SANG_OCULT_HECES,
    T_SGOT_TGO TYPE OF COLUMN V_ANALISIS.T_SGOT_TGO,
    T_SGOT_TGP TYPE OF COLUMN V_ANALISIS.T_SGOT_TGP,
    T_T3 TYPE OF COLUMN V_ANALISIS.T_T3,
    T_T4 TYPE OF COLUMN V_ANALISIS.T_T4,
    T_T4_LIBRE TYPE OF COLUMN V_ANALISIS.T_T4_LIBRE,
    T_COOMBS_DIRECTO TYPE OF COLUMN V_ANALISIS.T_COOMBS_DIRECTO,
    T_COOMBS_INDIRECTO TYPE OF COLUMN V_ANALISIS.T_COOMBS_INDIRECTO,
    T_TESTOSTERONA TYPE OF COLUMN V_ANALISIS.T_TESTOSTERONA,
    T_TIPIFICACION_SANGUINEA TYPE OF COLUMN V_ANALISIS.T_TIPIFICACION_SANGUINEA,
    T_TOXOPLAS_IGG TYPE OF COLUMN V_ANALISIS.T_TOXOPLAS_IGG,
    T_TOXOPLAS_IGM TYPE OF COLUMN V_ANALISIS.T_TOXOPLAS_IGM,
    T_TRIGLICERIDOS TYPE OF COLUMN V_ANALISIS.T_TRIGLICERIDOS,
    T_TSH TYPE OF COLUMN V_ANALISIS.T_TSH,
    T_TUBERCULINA TYPE OF COLUMN V_ANALISIS.T_TUBERCULINA,
    T_UREA TYPE OF COLUMN V_ANALISIS.T_UREA,
    OTROS TYPE OF COLUMN V_ANALISIS.OTROS,
    USER_NAME TYPE OF COLUMN V_ANALISIS.USER_NAME,
    ROL TYPE OF COLUMN V_ANALISIS.ROL )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_GENERALES
RETURNS (
    ID_PERSONA TYPE OF COLUMN V_GENERALES.ID_PERSONA,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    ID_TIPO_SANGRE TYPE OF COLUMN V_GENERALES.ID_TIPO_SANGRE,
    ESTADO_CIVIL TYPE OF COLUMN V_GENERALES.ESTADO_CIVIL )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_GET_CAJEROS
RETURNS (
    USER_NAME TYPE OF COLUMN GET_CAJEROS.USER_NAME,
    ROL TYPE OF COLUMN GET_CAJEROS.ROL,
    PNOMBRE TYPE OF COLUMN GET_CAJEROS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN GET_CAJEROS.SNOMBRE,
    APELLIDOS TYPE OF COLUMN GET_CAJEROS.APELLIDOS,
    ESTADO TYPE OF COLUMN GET_CAJEROS.ESTADO,
    DESCRIPCION TYPE OF COLUMN GET_CAJEROS.DESCRIPCION )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_GET_CLIENTES_SB
RETURNS (
    ID TYPE OF COLUMN GET_CLIENTES_SB.ID,
    CEDULA TYPE OF COLUMN GET_CLIENTES_SB.CEDULA,
    PERSONA TYPE OF COLUMN GET_CLIENTES_SB.PERSONA,
...
RETURNS (
    ...
    ESTADO_CATEGORIA TYPE OF COLUMN V_CATEGORIAS.ESTADO,
    CODIGO TYPE OF COLUMN V_PRODUCTOS.CODIGO,
    DESCRIPCION TYPE OF COLUMN V_PRODUCTOS.DESCRIPCION,
    IMAGEN_TEXTO TYPE OF COLUMN V_PRODUCTOS.IMAGEN_TEXTO,
    NOTA TYPE OF COLUMN V_PRODUCTOS.NOTA,
    FECHA_CREACION TYPE OF COLUMN V_PRODUCTOS.FECHA_CREACION,
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_PRODUCTOS_FIND (
    I_ID D_ID,
    I_CODIGO D_VARCHAR_25,
    I_DESCRIPCION D_VARCHAR_70 )
RETURNS (
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_PRODUCTOS_ID_CODIGO (
    I_ID D_ID,
    I_CODIGO D_VARCHAR_25 )
RETURNS (
    ID TYPE OF COLUMN V_PRODUCTOS.ID,
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_TURNOS
RETURNS (
    ID TYPE OF COLUMN V_TURNOS.ID,
    FECHA_HORA_INICIO TYPE OF COLUMN V_TURNOS.FECHA_HORA_INICIO,
    FECHA_HORA_FINAL TYPE OF COLUMN V_TURNOS.FECHA_HORA_FINAL,
    MONTO_FACTURADO TYPE OF COLUMN V_TURNOS.MONTO_FACTURADO,
    MONTO_DEVUELTO TYPE OF COLUMN V_TURNOS.MONTO_DEVUELTO,
    MONTO_EFECTIVO TYPE OF COLUMN V_TURNOS.MONTO_EFECTIVO,
    MONTO_CREDITO TYPE OF COLUMN V_TURNOS.MONTO_CREDITO,
    ROL TYPE OF COLUMN V_TURNOS.ROL,
    USER_NAME TYPE OF COLUMN V_TURNOS.USER_NAME )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO
RETURNS (
    ID TYPE OF COLUMN V_TURNOS.ID,
    TURNO_USUARIO TYPE OF COLUMN V_TURNOS.TURNO_USUARIO,
    ESTADO TYPE OF COLUMN V_TURNOS.ESTADO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_UPDATE_CATEGORIA (
    I_ID TYPE OF COLUMN V_CATEGORIAS.ID,
...
CREATE PROCEDURE SP_UPDATE_DIRECCION (
    ...
    I_ID_CODIGO_POSTAL D_ID,
    I_DIRECCION D_ID,
    I_ESTADO D_BOOLEAN_F,
    I_POR_DEFECTO D_BOOLEAN_F )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_VS_PERMISOS_ASIGNADOS (
    I_ROL TYPE OF COLUMN VS_PRIVILEGIO.USUARIO )
RETURNS (
    R_NOMBRE_RELACION TYPE OF COLUMN VS_PRIVILEGIO.NOMBRE_RELACION,
    R_GRANT_OPTION TYPE OF COLUMN VS_PRIVILEGIO.GRANT_OPTION,
    R_DESCRIPCION TYPE OF COLUMN VS_PROCEDIMIENTOS.DESCRIPCION )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_V_CATEGORIAS
RETURNS (
    ...
    FECHA_CREACION TYPE OF COLUMN V_CATEGORIAS.FECHA_CREACION,
    ESTADO TYPE OF COLUMN V_CATEGORIAS.ESTADO,
    USER_NAME TYPE OF COLUMN V_CATEGORIAS.USER_NAME )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
(
  ...
  ROL D_ROL,
  USER_NAME D_USER_NAME,
  CONSTRAINT PK_ANALISIS PRIMARY KEY (ID)
);
...
(
  ...
  CONSTRAINT INTEG_2585 PRIMARY KEY (ID),
...
(
  ...
  ROL D_ROL,
  MARCA D_VARCHAR_255,
  MODELO D_VARCHAR_255,
  NUMERO_SERIE D_VARCHAR_255,
  DIMENSIONES D_VARCHAR_255,
  PESO D_MEDIDA,
...
WHERE r.ROL LIKE 'CAJERO' AND r.USER_NAME NOT STARTING 'SYSDBA'
/*
...
AS SELECT TRIM(RDB$USER), TRIM(RDB$GRANTOR), TRIM(RDB$PRIVILEGE), RDB$GRANT_OPTION, 
       TRIM(RDB$RELATION_NAME), TRIM(RDB$FIELD_NAME), RDB$USER_TYPE, RDB$OBJECT_TYPE, p.RDB$DESCRIPTION
FROM RDB$USER_PRIVILEGES u
LEFT JOIN RDB$PROCEDURES p ON TRIM(p.RDB$PROCEDURE_NAME) = TRIM(u.RDB$RELATION_NAME)
...
FROM RDB$ROLES r
WHERE TRIM(r.RDB$ROLE_NAME) NOT STARTING WITH 'RRR_SOFTSURENA'
/*
...
AS SELECT TRIM(RDB$USER) USUARIO, TRIM(RDB$GRANTOR) GRANTOR, RDB$PRIVILEGE, F_PRIVILEGIO(RDB$PRIVILEGE) NOMBRE_ABREV, 
          RDB$GRANT_OPTION GRANT_OPTION, IIF(RDB$GRANT_OPTION = 0, 'NO', 'SI') CON_OPC_ADMIN, 
          TRIM(RDB$RELATION_NAME) RDB$RELATION_NAME, TRIM(RDB$FIELD_NAME) RDB$FIELD_NAME, RDB$USER_TYPE, 
          F_TIPO_USUARIO(RDB$USER_TYPE) TIPO_USUARIO, RDB$OBJECT_TYPE, F_OBJECTOS(RDB$OBJECT_TYPE) TIPO_OBJ
FROM RDB$USER_PRIVILEGES;
CREATE VIEW VS_PROCEDIMIENTOS (ID, PROCEDIMIENTO, PROPIETARIO, SQL_SECURITY, DESCRIPCION)
AS SELECT r.RDB$PROCEDURE_ID, TRIM(r.RDB$PROCEDURE_NAME) PROCEDIMIENTO,
     TRIM(r.RDB$OWNER_NAME) OWNER_NAME, r.RDB$SQL_SECURITY, TRIM(r.RDB$DESCRIPTION) DESCRIPCION
FROM RDB$PROCEDURES r
WHERE r.RDB$PROCEDURE_ID >= 0;
...
AS SELECT ID_FACTURA, ID_LINEA, ID_PRODUCTO, PRECIO, CANTIDAD
FROM D_FACTURAS 
WHERE ID_FACTURA >= 0;
...
AS SELECT ID, UUID_BASEDATOS, NOMBRE_EMPRESA, FCHI, FCHA, FCHV, 
     DATEDIFF(DAY FROM CURRENT_DATE TO FCHV) as DIAS_RESTANTES, TELEFONOS, DIRECCION, MENSAJE_FOOTER, LOGO, URLDB
FROM E_S_SYS
WHERE ID >= 0;
...
AS SELECT ID, ID_CLIENTE, ID_CONTACTOS_TEL, ID_CONTACTOS_DIRECCIONES, ID_CONTACTOS_EMAIL,
     ID_TURNO, FECHA_HORA, TOTAL, EFECTIVO, CAST((EFECTIVO - TOTAL) AS TYPE OF D_DINERO), 
...
WHERE ID >= 0;
CREATE VIEW V_PERSONAS_PACIENTES_ART (ID, PESO_NACIMIENTO_KG, ALTURA, PERIMETRO_CEFALICO, CESAREA, TIEMPO_GESTACION, 
     USER_NAME, MASA_CEFALICA)
...
AS SELECT r.ID, r.CODIGO
FROM PERSONAS_PROVEEDORES_ATR r;
...
AS SELECT r.ID, r.PAIS, r.CODIGO_CUENTA_CONTABLE, r.NOMBRE_CUENTA, r.TIPO_CUENTA, r.NIVEL_CUENTA, r.USA_TERCERO,
     r.CENTRO_COSTOS, r.PORCENTAJE_BASE, r.MONTO_BASE_MIN, r.DETALLE_CUENTA
FROM PLAN_CUENTA_CONTABLE r;
CREATE VIEW V_PRODUCTOS (ID, ID_CATEGORIA, CODIGO, DESCRIPCION, IMAGEN_TEXTO, NOTA, FECHA_CREACION, ESTADO, USER_NAME, 
     ROL)
AS SELECT ID, ID_CATEGORIA, CODIGO, DESCRIPCION, IMAGEN_TEXTO, NOTA, FECHA_CREACION, ESTADO, USER_NAME, ROL
FROM PRODUCTOS
WHERE ID >= 0;
...
AS SELECT r.ID_PADRE_O_MADRE, r.ID_ESTUDIANTE
FROM RELACION_PADRE_ESTUDIANTE r;
CREATE VIEW V_RELACION_PADRE_PACIENTE (ID_PADRE_O_MADRE, ID_PACIENTE)
AS SELECT r.ID_PADRE_O_MADRE, r.ID_PACIENTE
FROM RELACION_PADRE_PACIENTE r;
...
BEGIN
     /* 
          Aqui van los permisos que necesita un usuario para crear facturas.
          
          TRUE + TRUE         Otorga al rol los procedimientos con WITH GRANT OPTION;
          
          TRUE + FALSE        Otorga al rol los procedimientos sin WITH GRANT OPTION;
          
          FALSE + TRUE        QUITA el WITH GRANT OPTION
          
          FALSE + FALSE       Elimina los permisos de la lista de procedimientos por completo. 
          
          GRANT EXECUTE ON PROCEDURE ADMIN_SET_ROLE TO "PUBLIC";
          GRANT EXECUTE ON PROCEDURE ADMIN_SET_ROLE TO "PUBLIC" WITH GRANT OPTION;
          REVOKE EXECUTE ON PROCEDURE ADMIN_SET_ROLE FROM "PUBLIC";
          REVOKE GRANT OPTION FOR EXECUTE ON PROCEDURE ADMIN_SET_ROLE FROM "PUBLIC";
...
BEGIN
     ...
     */ 
     IF(I_OTORGAR)THEN BEGIN
          V_SQL = 'GRANT EXECUTE ON PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO TO '||:I_ROL||(IIF(:I_CON_ADMIN,' WITH GRANT OPTION;', ';'));
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'GRANT EXECUTE ON PROCEDURE SP_GET_CATEGORIA_ACTIVAS TO '||:I_ROL||(IIF(:I_CON_ADMIN,' WITH GRANT OPTION;', ';'));
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'GRANT EXECUTE ON PROCEDURE SP_GET_CLIENTES_SB TO '||:I_ROL||(IIF(:I_CON_ADMIN,' WITH GRANT OPTION;', ';'));
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'GRANT EXECUTE ON PROCEDURE SP_V_CATEGORIAS TO '||:I_ROL||(IIF(:I_CON_ADMIN,' WITH GRANT OPTION;', ';'));
          EXECUTE STATEMENT V_SQL;
          ...
          EXECUTE STATEMENT V_SQL;
     END ELSE BEGIN 
          V_SQL = 'REVOKE '||(IIF(:I_CON_ADMIN,' GRANT OPTION FOR ', ''))||' EXECUTE ON PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO FROM '||:I_ROL;
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'REVOKE '||(IIF(:I_CON_ADMIN,' GRANT OPTION FOR ', ''))||' EXECUTE ON PROCEDURE SP_GET_CATEGORIA_ACTIVAS FROM '||:I_ROL;
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'REVOKE '||(IIF(:I_CON_ADMIN,' GRANT OPTION FOR ', ''))||' EXECUTE ON PROCEDURE SP_GET_CLIENTES_SB FROM '||:I_ROL;
          EXECUTE STATEMENT V_SQL;
          V_SQL = 'REVOKE '||(IIF(:I_CON_ADMIN,' GRANT OPTION FOR ', ''))||' EXECUTE ON PROCEDURE SP_V_CATEGORIAS FROM '||:I_ROL;
          EXECUTE STATEMENT V_SQL;
...
SET TERM ^ ;
ALTER PROCEDURE SP_GET_CATEGORIA_ACTIVAS
RETURNS (
    ID TYPE OF COLUMN GET_CATEGORIA_ACTIVAS.ID,
    DESCRIPCION TYPE OF COLUMN GET_CATEGORIA_ACTIVAS.DESCRIPCION,
    IMAGEN_TEXTO TYPE OF COLUMN GET_CATEGORIA_ACTIVAS.IMAGEN_TEXTO )
...
SET TERM ^ ;
ALTER PROCEDURE SP_GET_CLIENTES_SB
RETURNS (
    ID TYPE OF COLUMN GET_CLIENTES_SB.ID,
    CEDULA TYPE OF COLUMN GET_CLIENTES_SB.CEDULA,
    PERSONA TYPE OF COLUMN GET_CLIENTES_SB.PERSONA,
...
SET TERM ^ ;
ALTER PROCEDURE SP_INSERT_DIRECCION (
    I_ID_PERSONA D_ID,
    I_ID_PROVINCIA D_ID,
    I_ID_MUNICIPIO D_ID,
    I_ID_DISTRITO_MUNICIPAL D_ID,
...
BEGIN
     ...
     V_ID = GEN_ID(G_ID_DIRECCIONES, 1);
     ...
     VALUES (NULL, :I_ID_PERSONA, :I_ID_PROVINCIA, :I_ID_MUNICIPIO, :I_ID_DISTRITO_MUNICIPAL, 
          :I_ID_CODIGO_POSTAL, :I_DIRECCION)
     RETURNING ID
     INTO V_ID;
END
^
...
BEGIN
     IF((SELECT (1) 
          FROM SEC$USERS r 
          WHERE TRIM(r.SEC$USER_NAME) LIKE TRIM(:I_USER_NAME)) = 1)THEN
               EXCEPTION E_USUARIO_REGISTRADO;
...
SET TERM ^ ;
ALTER PROCEDURE SP_PRODUCTOS_FIND
RETURNS (
    ID TYPE OF COLUMN V_PRODUCTOS.ID,
    CODIGO TYPE OF COLUMN V_PRODUCTOS.CODIGO,
    DESCRIPCION TYPE OF COLUMN V_PRODUCTOS.DESCRIPCION )
...
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_ANALISIS
RETURNS (
    ID TYPE OF COLUMN V_ANALISIS.ID,
    ID_PACIENTE TYPE OF COLUMN V_ANALISIS.ID_PACIENTE,
    FECHA_HORA_CREADA TYPE OF COLUMN V_ANALISIS.FECHA_HORA_CREADA,
...
BEGIN
     FOR SELECT 
          ...
          a.T_ASO_LATEX, 
          a.T_BILIRRUBINA, 
          a.T_COLESTEROL_TOTAL, 
          a.T_COLESTEROL_HDL, 
          a.T_COLESTEROL_HDL_LDL, 
          a.T_COPROLOGICO, 
          a.T_CREATININA_SUERO, 
          a.T_CULTIVO_FARINGE, 
          a.T_CULTIVO_HECES, 
          a.T_CULTIVO_HERIDA_AEROBICO, 
          a.T_CULTIVO_OIDO, 
          a.T_CULTIVO_SANGRE, 
          a.T_CULTIVO_SEMEN, 
          a.T_CULTIVO_URETRA, 
          a.T_CULTIVO_VAGINA, 
          a.T_ELECTRO_HEMOGLOBINA, 
          a.T_ERITROSEDIMENTACION, 
          a.T_ESPERMATOGRAMA, 
          a.T_ESTRADIOL, 
          a.T_ESTROGENO_TOTALES, 
          a.T_FACTOR_REUMATOIDE, 
          a.T_FALCEMIA, 
          a.T_FOSFATASA_ALCALINA, 
          a.T_FSH, 
          a.T_GLICEMIA, 
          a.T_HEMOGLO_GLUCOSILADA, 
          a.T_HEMOGRAMA, 
          a.T_HEPATITIS_A, 
          a.T_HEPATITIS_C, 
          a.T_KOH, 
          ...
          a.T_PROGESTERONA, 
          a.T_PROLACTINA, 
          a.T_PROTEINAS_TOTALES, 
          a.T_PSA_TOTAL, 
          a.T_PSA_LIBRE, 
          a.T_SANG_OCULT_HECES, 
          a.T_SGOT_TGO, 
          a.T_SGOT_TGP, 
          a.T_T3, 
          a.T_T4, 
          a.T_T4_LIBRE, 
          a.T_COOMBS_DIRECTO, 
          a.T_COOMBS_INDIRECTO, 
          a.T_TESTOSTERONA, 
          a.T_TIPIFICACION_SANGUINEA, 
          a.T_TOXOPLAS_IGG, 
          a.T_TOXOPLAS_IGM, 
          a.T_TRIGLICERIDOS, 
          a.T_TSH, 
     ...
     INTO 
          ...
          T_COLESTEROL_TOTAL, 
          T_COLESTEROL_HDL, 
          T_COLESTEROL_HDL_LDL, 
          T_COPROLOGICO, 
          T_CREATININA_SUERO, 
          T_CULTIVO_FARINGE, 
          T_CULTIVO_HECES, 
          T_CULTIVO_HERIDA_AEROBICO, 
          T_CULTIVO_OIDO, 
          T_CULTIVO_SANGRE, 
          T_CULTIVO_SEMEN, 
          T_CULTIVO_URETRA, 
          T_CULTIVO_VAGINA, 
          T_ELECTRO_HEMOGLOBINA, 
          T_ERITROSEDIMENTACION, 
          T_ESPERMATOGRAMA, 
          T_ESTRADIOL, 
          T_ESTROGENO_TOTALES, 
          T_FACTOR_REUMATOIDE, 
          T_FALCEMIA, 
          T_FOSFATASA_ALCALINA, 
          T_FSH, 
          T_GLICEMIA, 
          T_HEMOGLO_GLUCOSILADA, 
          T_HEMOGRAMA, 
          T_HEPATITIS_A, 
          T_HEPATITIS_C, 
          T_KOH, 
...
COMMENT ON PROCEDURE SP_SELECT_GENERALES IS 'Permiso que permite a los usuarios consultar los datos de los clientes por cedula.';
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_GENERALES
RETURNS (
    ID_PERSONA TYPE OF COLUMN V_GENERALES.ID_PERSONA,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    ID_TIPO_SANGRE TYPE OF COLUMN V_GENERALES.ID_TIPO_SANGRE,
...
BEGIN
     FOR SELECT 
          ...
          a.ESTADO_CIVIL
     FROM V_GENERALES a
     WHERE a.ID_PERSONA >= 0 
     --PLAN (a INDEX(PK_GENERALES_0)) 
     INTO 
          ID_PERSONA, 
          CEDULA, 
          ID_TIPO_SANGRE, 
...
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_GET_CAJEROS
RETURNS (
    USER_NAME TYPE OF COLUMN GET_CAJEROS.USER_NAME,
    ROL TYPE OF COLUMN GET_CAJEROS.ROL,
    PNOMBRE TYPE OF COLUMN GET_CAJEROS.PNOMBRE,
...
COMMENT ON PROCEDURE SP_SELECT_GET_CLIENTES_SB IS 'Procedimiento que permite obtener un listado de clientes del sistema. 


';
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_GET_CLIENTES_SB
RETURNS (
    ID TYPE OF COLUMN GET_CLIENTES_SB.ID,
    CEDULA TYPE OF COLUMN GET_CLIENTES_SB.CEDULA,
    PERSONA TYPE OF COLUMN GET_CLIENTES_SB.PERSONA,
...
COMMENT ON PROCEDURE SP_SELECT_PRODUCTOS IS 'Permite consultar los productos y la cetegorias del sistema.';
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_PRODUCTOS
RETURNS (
    ID TYPE OF COLUMN V_PRODUCTOS.ID,
    ID_CATEGORIA TYPE OF COLUMN V_PRODUCTOS.ID_CATEGORIA,
    ESTADO_CATEGORIA TYPE OF COLUMN V_CATEGORIAS.ESTADO,
...
BEGIN
     FOR SELECT 
          ...
          a.ROL
     FROM V_PRODUCTOS a
     LEFT JOIN V_CATEGORIAS c ON c.ID = a.ID_CATEGORIA
     WHERE a.ID >= 0 AND a.ID_CATEGORIA >= 0
     INTO 
          ID, 
          ID_CATEGORIA,
          ESTADO_CATEGORIA,
...
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_PRODUCTOS_FIND (
    I_ID D_ID,
    I_CODIGO D_VARCHAR_25,
    I_DESCRIPCION D_VARCHAR_70 )
RETURNS (
...
BEGIN
     FOR SELECT 
          ...
          a.DESCRIPCION
     FROM V_PRODUCTOS a
     WHERE a.ID = :I_ID OR a.CODIGO STARTING WITH :I_CODIGO OR a.DESCRIPCION STARTING WITH :I_DESCRIPCION OR a.DESCRIPCION CONTAINING:I_DESCRIPCION
     INTO 
          ID, 
          CODIGO, 
          DESCRIPCION 
...
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_PRODUCTOS_ID_CODIGO (
    I_ID D_ID,
    I_CODIGO D_VARCHAR_25 )
RETURNS (
    ID TYPE OF COLUMN V_PRODUCTOS.ID,
...
BEGIN
     FOR SELECT 
          ID, ID_CATEGORIA, CODIGO, DESCRIPCION, IMAGEN_TEXTO, NOTA, 
          FECHA_CREACION, ESTADO, USER_NAME, ROL
     FROM V_PRODUCTOS a
     WHERE a.ID >= :I_ID AND 
           UPPER(TRIM(a.CODIGO)) STARTING WITH UPPER(TRIM(:I_CODIGO)) OR
           UPPER(TRIM(a.DESCRIPCION)) STARTING WITH UPPER(TRIM(:I_CODIGO)) OR
           UPPER(TRIM(a.DESCRIPCION)) CONTAINING UPPER(TRIM(:I_CODIGO)) OR
           UPPER(TRIM(a.CODIGO)) CONTAINING UPPER(TRIM(:I_CODIGO)) 
     INTO 
          ID, ID_CATEGORIA, CODIGO, DESCRIPCION, IMAGEN_TEXTO, NOTA, 
          FECHA_CREACION, ESTADO, USER_NAME, ROL 
     DO
...
COMMENT ON PROCEDURE SP_SELECT_TURNOS IS 'Este procedimiento contiene los detalles de los turnos que el sistema de 
facturacion tiene activos. 

Atributos que pueden ser accedido por ciertos usuarios del sistema.
';
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_TURNOS
RETURNS (
    ID TYPE OF COLUMN V_TURNOS.ID,
    FECHA_HORA_INICIO TYPE OF COLUMN V_TURNOS.FECHA_HORA_INICIO,
    FECHA_HORA_FINAL TYPE OF COLUMN V_TURNOS.FECHA_HORA_FINAL,
...
COMMENT ON PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO IS 'Este procedimiento permite consultar a los usuarios que tienen turnos activos
en el sistema de facturacion. 
';
SET TERM ^ ;
ALTER PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO
RETURNS (
    ID TYPE OF COLUMN V_TURNOS.ID,
    TURNO_USUARIO TYPE OF COLUMN V_TURNOS.TURNO_USUARIO,
    ESTADO TYPE OF COLUMN V_TURNOS.ESTADO )
...
conjunto de datos de las etiquetas que tienen los usuarios en el 
sistema.
...
COMMENT ON PARAMETER I_USER_NAME IS 'Nombre de usuario en el sistema.';
COMMENT ON PARAMETER O_TAG_NOMBRE IS 'Nombre de la etiqueta.';
COMMENT ON PARAMETER O_TAG_VALOR IS 'Valor de la etiqueta.';
...
SET TERM ^ ;
ALTER PROCEDURE SP_UPDATE_CATEGORIA (
    I_ID TYPE OF COLUMN V_CATEGORIAS.ID,
    I_DESCRIPCION TYPE OF COLUMN V_CATEGORIAS.DESCRIPCION,
    I_IMAGEN_TEXTO TYPE OF COLUMN V_CATEGORIAS.IMAGEN_TEXTO,
    I_ESTADO TYPE OF COLUMN V_CATEGORIAS.ESTADO )
...
BEGIN
     IF((SELECT (1) 
          FROM V_CATEGORIAS c 
          WHERE TRIM(c.DESCRIPCION) LIKE TRIM(:I_DESCRIPCION)) = 1)THEN
...
SET TERM ^ ;
ALTER PROCEDURE SP_UPDATE_DIRECCION (
    I_ID D_ID,
    I_ID_PROVINCIA D_ID,
    I_ID_MUNICIPIO D_ID,
    I_ID_DISTRITO_MUNICIPAL D_ID,
...
BEGIN
     ...
     */
     ...
     SET 
          ...
          ID_DISTRITO_MUNICIPAL = :I_ID_DISTRITO_MUNICIPAL, 
          ID_CODIGO_POSTAL = :I_ID_CODIGO_POSTAL, 
          DIRECCION = :I_DIRECCION, 
          ESTADO = :I_ESTADO, 
          POR_DEFECTO = :I_POR_DEFECTO
     WHERE
          ID = :I_ID;
END
^
...
BEGIN
     ...
     IF((SELECT (1) 
          FROM SEC$USERS r 
          WHERE TRIM(r.SEC$USER_NAME) LIKE (TRIM(:I_USER_NAME))) IS NULL)THEN
               EXCEPTION E_USUARIO_NO_ENCONTRADO;
...
COMMENT ON PARAMETER I_USER_NAME IS 'Parametro de entrada que recibe el nombre de usuario, el cual sera verificado de que no exista en la base de datos. ';
COMMENT ON PARAMETER O_USER_NAME IS 'Parametro de salida con el nombre de usuario a utilizar en el sistema.';

SET TERM ^ ;
ALTER PROCEDURE SP_VS_PERMISOS_ASIGNADOS (
    I_ROL TYPE OF COLUMN VS_PRIVILEGIO.USUARIO )
RETURNS (
    R_NOMBRE_RELACION TYPE OF COLUMN VS_PRIVILEGIO.NOMBRE_RELACION,
    R_GRANT_OPTION TYPE OF COLUMN VS_PRIVILEGIO.GRANT_OPTION,
...
AS
BEGIN
     FOR SELECT TRIM(r.NOMBRE_RELACION) NOMBRE_RELACION, r.GRANT_OPTION, p.DESCRIPCION 
     FROM VS_PRIVILEGIO r 
     INNER JOIN VS_PROCEDIMIENTOS p ON TRIM(p.PROCEDIMIENTO) LIKE TRIM(r.NOMBRE_RELACION) 
     WHERE r.ID_TIPO_OBJ = 5 AND 
           TRIM(r.USUARIO) STARTING WITH :I_ROL AND 
           TRIM(r.NOMBRE_RELACION) STARTING WITH 'PERM_'
     INTO 
          R_NOMBRE_RELACION,
          R_GRANT_OPTION,
          R_DESCRIPCION
...
SET TERM ^ ;
ALTER PROCEDURE SP_V_CATEGORIAS
RETURNS (
    ID TYPE OF COLUMN V_CATEGORIAS.ID,
    DESCRIPCION TYPE OF COLUMN V_CATEGORIAS.DESCRIPCION,
    IMAGEN_TEXTO TYPE OF COLUMN V_CATEGORIAS.IMAGEN_TEXTO,
...
ALTER TABLE ANALISIS ADD CONSTRAINT FK_ANALISIS
...
GRANT DOCTOR TO JHASLYN WITH ADMIN OPTION;
GRANT DOCTOR TO RDB$ADMIN WITH ADMIN OPTION;
GRANT DOCTOR TO SYSDBA WITH ADMIN OPTION;
GRANT GERENTE TO JHASLYN;
GRANT GERENTE TO RDB$ADMIN WITH ADMIN OPTION;
GRANT GERENTE TO SYSDBA WITH ADMIN OPTION;
...
GRANT RRHH TO VENDEDOR;
GRANT RRR_SOFTSURENA TO RDB$ADMIN WITH ADMIN OPTION;
GRANT RRR_SOFTSURENA TO SYSDBA WITH ADMIN OPTION;
GRANT SECRETARIA TO JHADIEL WITH ADMIN OPTION;
GRANT SECRETARIA TO RDB$ADMIN WITH ADMIN OPTION;
GRANT SECRETARIA TO SYSDBA WITH ADMIN OPTION;
GRANT VENDEDOR TO JHADIEL;
GRANT VENDEDOR TO RDB$ADMIN WITH ADMIN OPTION;
GRANT VENDEDOR TO SYSDBA WITH ADMIN OPTION;
GRANT EXECUTE
 ON FUNCTION F_OBJECTOS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON FUNCTION F_OBJECTOS TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON FUNCTION F_PROCEDIMIENTOS_SHOW TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON FUNCTION F_PROCEDIMIENTOS_SHOW TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON FUNCTION F_TIPO_USUARIO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON FUNCTION F_TIPO_USUARIO TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE ADMIN_AGREGAR_PERMISO_ADMIN_ROLE TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADMIN_AGREGAR_PERMISO_ADMIN_ROLE TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE ADMIN_BORRAR_ROLE TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADMIN_BORRAR_ROLE TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADMIN_CAMBIAR_CLAVE_USUARIO_ACTUAL TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADMIN_CAMBIAR_CLAVE_USUARIO_ACTUAL TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE ADMIN_CREATE_ROLE TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADMIN_CREATE_ROLE TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE ADMIN_QUITAR_PERMISO_ADMIN_ROL TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADMIN_QUITAR_PERMISO_ADMIN_ROL TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE PARSER TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE PARSER TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE PERM_BASICOS TO ROLE CAJERO;

GRANT EXECUTE
 ON PROCEDURE PERM_BASICOS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE PERM_BASICOS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE PERM_CREAR_FACTURAS TO ROLE CAJERO;

GRANT EXECUTE
 ON PROCEDURE PERM_CREAR_FACTURAS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE PERM_CREAR_FACTURAS TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_DELETE_ANTECEDENTE TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_DELETE_ANTECEDENTE TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_DELETE_CLIENTE_CC TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_DELETE_CLIENTE_CC TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_DELETE_PRODUCTO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_DELETE_PRODUCTO TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_DELETE_USUARIO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_DELETE_USUARIO TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_GET_CATEGORIA_ACTIVAS TO ROLE CAJERO;

GRANT EXECUTE
 ON PROCEDURE SP_GET_CATEGORIA_ACTIVAS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_GET_CATEGORIA_ACTIVAS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_GET_CLIENTES_SB TO ROLE CAJERO;

GRANT EXECUTE
 ON PROCEDURE SP_GET_CLIENTES_SB TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_GET_CLIENTES_SB TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_ANTECEDENTE TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_CARTON_BINGO TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_DETALLE_RECETAS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_DETALLE_RECETAS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_DIRECCION TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_DIRECCION TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_DOCTOR TO  ADMINISTRADOR WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_PERSONA_CLIENTES_ID TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_PERSONA_CLIENTES_ID TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_PRODUCTO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_PRODUCTO TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_USUARIO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_INSERT_USUARIO TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_PRODUCTOS_FIND TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_PRODUCTOS_FIND TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_ANALISIS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_ANALISIS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_GENERALES TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_GENERALES TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_GET_CAJEROS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_GET_CAJEROS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_GET_CLIENTES_SB TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_SELECT_GET_PRODUCTOS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_PRODUCTOS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_PRODUCTOS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_PRODUCTOS_FIND TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_PRODUCTOS_FIND TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_PRODUCTOS_ID_CODIGO TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_SELECT_TURNOS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO TO ROLE CAJERO;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_TURNOS_POR_CAMPOS_PUBLICO TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_USUARIOS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_SELECT_USUARIOS TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_ANTECEDENTE TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_ARS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_ARS TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_CATEGORIA TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_CATEGORIA TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_DIRECCION TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_DIRECCION TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_DIRECCION_CLIENTE TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_DIRECCION_CLIENTE TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_PRODUCTO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_PRODUCTO TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_PROVEEDORES TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_PROVEEDORES TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_USUARIO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_USUARIO TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_VALIDAR_USUARIO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_VALIDAR_USUARIO TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_VS_PERMISOS_ASIGNADOS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_VS_PERMISOS_ASIGNADOS TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_V_CATEGORIAS TO ROLE CAJERO;

GRANT EXECUTE
 ON PROCEDURE SP_V_CATEGORIAS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SP_V_CATEGORIAS TO  SYSDBA WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SYS_RECCOUNT TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SYS_RECCOUNT TO  SYSDBA WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SYS_RECCOUNT_ESTADO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE SYS_RECCOUNT_ESTADO TO  SYSDBA WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON PLAN_CUENTA_CONTABLE TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON T_PRUEBA TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON T_PRUEBA TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON GET_CAJEROS TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON GET_CLIENTES_CC TO ROLE RDB$ADMIN WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON VS_PRIVILEGIO TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON VS_PRIVILEGIO TO  SYSDBA WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON VS_PROCEDIMIENTOS TO ROLE RDB$ADMIN WITH GRANT OPTION;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON VS_PROCEDIMIENTOS TO  SYSDBA WITH GRANT OPTION;
...
GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE
 ON V_PERSONAS_CLIENTES_ATR TO ROLE RDB$ADMIN WITH GRANT OPTION;
