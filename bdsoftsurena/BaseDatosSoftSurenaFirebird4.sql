...
CREATE PROCEDURE SP_VS_PERMISOS_ASIGNADOS (
    ...
    I_SUFIJO TYPE OF COLUMN VS_PRIVILEGIO.USUARIO )
RETURNS (
...
COMMENT ON PROCEDURE SP_SELECT_TURNOS IS 'Procedimiento creado para obtener los resultados de los turnos de los cajeros del sistema.';
SET TERM ^ ;
...
BEGIN
     ...
     */
     ...
     FOR SELECT 
            TRIM(CAST(U.SEC$USER_NAME AS D_USER_NAME)) AS USUARIO,
            TRIM(U.SEC$FIRST_NAME)                  AS PRIMER_NOMBRE,
            TRIM(U.SEC$MIDDLE_NAME)                 AS SEGUNDO_NOMBRE,
            TRIM(U.SEC$LAST_NAME)                   AS APELLIDO,
            U.SEC$ACTIVE                      AS ESTA_ACTIVO,
            U.SEC$ADMIN                       AS ES_ADMIN,
          ...
          DO BEGIN
               SUSPEND;
               /*
                 Tabla que nos brinda la informacion o
...
BEGIN
     ...
     WHERE r.ID_TIPO_OBJ = 5 AND TRIM(r.USUARIO) STARTING WITH :I_ROL AND TRIM(r.NOMBRE_RELACION) STARTING WITH :I_SUFIJO
     INTO 
          R_NOMBRE_RELACION,
          R_GRANT_OPTION,
          R_DESCRIPCION
...
GRANT CAJERO TO PRUEBA WITH ADMIN OPTION;
...
GRANT VENDEDOR TO JHIRONSEL WITH ADMIN OPTION;
...
GRANT EXECUTE
 ON PROCEDURE ADMIN_HABILITAR_TURNO TO ROLE CAJERO WITH GRANT OPTION;

GRANT EXECUTE
 ON PROCEDURE ADMIN_HABILITAR_TURNO TO ROLE DOCTOR WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE PRO_PERMISOS TO ROLE CAJERO WITH GRANT OPTION;
...
GRANT EXECUTE
 ON PROCEDURE SP_DELETE_USUARIO TO ROLE DOCTOR;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_PACIENTE TO ROLE PADRE;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_PADRES TO ROLE PADRE;
...
GRANT EXECUTE
 ON PROCEDURE SYS_RECCOUNT TO  "PUBLIC";
...
GRANT EXECUTE
 ON PROCEDURE SYS_RECCOUNT_ESTADO TO  "PUBLIC";
