...
CREATE PROCEDURE SP_D_CONTACTO_TEL (
    ID TYPE OF COLUMN V_CONTACTOS_TEL.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_D_M_FACTURA (
    I_ID TYPE OF COLUMN V_M_FACTURAS.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
RETURNS (
    O_ID TYPE OF COLUMN V_ALMACENES.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_I_ARS (
    DESCRIPCION TYPE OF COLUMN V_ARS.DESCRIPCION,
    COVER_CONSULTA_POR_C TYPE OF COLUMN V_ARS.COVERTURA_CONSULTA_PORCIENTO,
    ESTADO TYPE OF COLUMN V_ARS.ESTADO )
RETURNS (
    O_ID TYPE OF COLUMN V_ARS.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_I_CLIENTE_SB (
    I_PERSONA TYPE OF COLUMN V_PERSONAS.PERSONA,
    I_CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    I_PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    I_SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
    I_APELLIDOS TYPE OF COLUMN V_PERSONAS.APELLIDOS,
    I_SEXO TYPE OF COLUMN V_PERSONAS.SEXO,
    I_FECHA_NACIMIENTO TYPE OF COLUMN V_PERSONAS.FECHA_NACIMIENTO,
    I_ESTADO TYPE OF COLUMN V_PERSONAS.ESTADO,
    I_ESTADO_CIVIL TYPE OF COLUMN V_GENERALES.ESTADO_CIVIL )
RETURNS (
    V_ID D_ID )
SQL SECURITY DEFINER
AS 
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_DIRECCION (
...
RETURNS (
    O_ID TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_I_M_FACTURA (
    I_ID_CLIENTE TYPE OF COLUMN V_M_FACTURAS.ID_CLIENTE,
    I_ID_CONTACTOS_TEL TYPE OF COLUMN V_M_FACTURAS.ID_CONTACTOS_TEL,
    I_ID_CONTACTOS_DIRECCIONES TYPE OF COLUMN V_M_FACTURAS.ID_CONTACTOS_DIRECCIONES,
    I_ID_CONTACTOS_EMAIL TYPE OF COLUMN V_M_FACTURAS.ID_CONTACTOS_EMAIL,
    I_ID_TURNO TYPE OF COLUMN V_M_FACTURAS.ID_TURNO,
    I_TOTAL TYPE OF COLUMN V_M_FACTURAS.TOTAL,
    I_EFECTIVO TYPE OF COLUMN V_M_FACTURAS.EFECTIVO,
    I_ESTADO_FACTURA TYPE OF COLUMN V_M_FACTURAS.ESTADO_FACTURA,
    I_NOMBRE_TEMP TYPE OF COLUMN V_M_FACTURAS.NOMBRE_TEMP )
RETURNS (
    O_ID TYPE OF COLUMN V_M_FACTURAS.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_I_PACIENTE (
    I_ID_PADRE TYPE OF COLUMN V_RELACION_PADRE_PACIENTE.ID_PADRE_O_MADRE,
    I_ID_MADRE TYPE OF COLUMN V_RELACION_PADRE_PACIENTE.ID_PADRE_O_MADRE,
    I_ID_ARS TYPE OF COLUMN V_ASEGURADOS.ID_ARS,
    I_NO_NSS TYPE OF COLUMN V_ASEGURADOS.NO_NSS,
    I_CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    I_PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    I_SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
    I_APELLIDOS TYPE OF COLUMN V_PERSONAS.APELLIDOS,
    I_SEXO TYPE OF COLUMN V_PERSONAS.SEXO,
    I_FECHA_NACIMIENTO TYPE OF COLUMN V_PERSONAS.FECHA_NACIMIENTO,
    I_ID_TIPO_SANGRE TYPE OF COLUMN V_GENERALES.ID_TIPO_SANGRE,
    I_ESTADO TYPE OF COLUMN V_PERSONAS.ESTADO )
RETURNS (
...
SET TERM ^ ;
CREATE PROCEDURE SP_UPDATE_OR_INSERT_CORREO (
...
CREATE PROCEDURE SP_U_CONTACTO_TEL (
    ID TYPE OF COLUMN V_CONTACTOS_TEL.ID,
    TELEFONO TYPE OF COLUMN V_CONTACTOS_TEL.TELEFONO,
    TIPO TYPE OF COLUMN V_CONTACTOS_TEL.TIPO,
    ESTADO TYPE OF COLUMN V_CONTACTOS_TEL.ESTADO,
    POR_DEFECTO TYPE OF COLUMN V_CONTACTOS_TEL.POR_DEFECTO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
WHERE ID >= 0;
CREATE VIEW V_DEUDAS (ID, ID_CLIENTE, CONCEPTO, MONTO, FECHA, HORA, ESTADO)
AS /*
...
FROM D_RECETAS 
WHERE ID_RECETA >= 0;
CREATE VIEW V_E_S_SYS (ID, NOMBRE_EMPRESA, FCHI, FCHA, FCHV, DIAS_RESTANTES, TELEFONOS, DIRECCION, MENSAJE_FOOTER, LOGO)
AS /*
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER CODIGOS_POSTALES_BI FOR CODIGOS_POSTALES ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER DEUDAS_BI FOR DEUDAS ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER DISTRITOS_MUNICIPALES_BI FOR DISTRITOS_MUNICIPALES ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER E_S_SYS_BI FOR E_S_SYS ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER GUIA_VIGILANCIA_DESARROLLO_BI FOR GUIA_VIGILANCIA_DESARROLLO ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER MOTIVO_CONSULTA_BI FOR MOTIVO_CONSULTA ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER MUNICIPIOS_BI FOR MUNICIPIOS ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER PLAN_CUENTA_CONTABLE_BI FOR PLAN_CUENTA_CONTABLE ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER PROVINCIAS_BI FOR PROVINCIAS ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER RECETAS_BI FOR RECETAS ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ; ^
SET TERM ^ ;
CREATE TRIGGER TIPOS_SANGRE_BI FOR TIPOS_SANGRE ACTIVE
BEFORE INSERT POSITION 0
...
SET TERM ^ ;
ALTER PROCEDURE SP_DELETE_CATEGORIA (
    V_ID D_ID )
SQL SECURITY DEFINER
...
AS
BEGIN
    --TODO CREAR VALIDACIONES ANTES DE ELIMINAR UNA FACTURA.
...
BEGIN
     ...
     */
     IF((SELECT DISTINCT (1) FROM V_CONSULTAS WHERE ID = :I_ID_CONSULTA AND ESTADO) IS NULL)THEN
...
SET TERM ^ ;
ALTER PROCEDURE SP_INSERT_CATEGORIA (
    DESCRIPCION D_VARCHAR_25,
    IMAGEN_TEXTO D_BLOB_TEXTO,
    ESTADO D_BOOLEAN_T )
RETURNS (
...
SET TERM ^ ;
ALTER PROCEDURE SP_INSERT_CONSULTA (
    ID_PACIENTE TYPE OF COLUMN CONSULTAS.ID_PACIENTE,
    ID_CONTROL_CONSULTA TYPE OF COLUMN CONSULTAS.ID_CONTROL_CONSULTA,
    ID_TURNO TYPE OF COLUMN CONSULTAS.TURNO,
    FECHA TYPE OF COLUMN CONSULTAS.FECHA )
...
BEGIN
     ...
     */
     if((SELECT DISTINCT (1) FROM V_GENERALES WHERE CEDULA LIKE :I_CEDULA) IS NOT NULL) THEN
...
BEGIN
     ...
     IF(:I_CEDULA <> NULL OR :I_CEDULA <> '000-0000000-0')THEN
     BEGIN
          --Ingresando el cliente
...
SET TERM ^ ;
ALTER PROCEDURE SP_I_DIRECCION (
    I_ID_PERSONA TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_PERSONA,
    I_ID_PROVINCIA TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_PROVINCIA,
    I_ID_MUNICIPIO TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_MUNICIPIO,
    I_ID_DISTRITO_MUNICIPAL TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_DISTRITO_MUNICIPAL,
...
BEGIN
     ...
     INSERT INTO V_CONTACTOS_DIRECCIONES(ID, ID_PERSONA, ID_PROVINCIA, ID_MUNICIPIO,
          ID_DISTRITO_MUNICIPAL, ID_CODIGO_POSTAL, DIRECCION, POR_DEFECTO)
     VALUES (NULL, :I_ID_PERSONA, :I_ID_PROVINCIA, :I_ID_MUNICIPIO, :I_ID_DISTRITO_MUNICIPAL, 
          :I_ID_CODIGO_POSTAL, :I_DIRECCION, :I_POR_DEFECTO)
     RETURNING (ID)
     INTO O_ID;
...
BEGIN
     ...
     */
     ...
     IF(:I_ID_CONTACTOS_TEL <> 0 AND (SELECT DISTINCT (1) 
     ...
     --Por igual.
     IF(:I_ID_CONTACTOS_EMAIL <> 0 AND (SELECT DISTINCT (1) 
     ...
     --Por igual.
     IF(:I_ID_CONTACTOS_DIRECCIONES <> 0 AND (SELECT DISTINCT (1) 
     ...
     VALUES (NULL, :I_ID_CLIENTE, :I_ID_CONTACTOS_TEL, :I_ID_CONTACTOS_DIRECCIONES, :I_ID_CONTACTOS_EMAIL, 
...
BEGIN
    ...
    IF((SELECT DISTINCT (1) FROM V_CATEGORIAS WHERE DESCRIPCION LIKE :I_DESCRIPCION) = 1)THEN
...
SET TERM ^ ;
ALTER PROCEDURE SP_UPDATE_OR_INSERT_CORREO (
    ID TYPE OF COLUMN CONTACTOS_EMAIL.ID,
    ID_PERSONA TYPE OF COLUMN CONTACTOS_EMAIL.ID_PERSONA,
    EMAIL TYPE OF COLUMN CONTACTOS_EMAIL.EMAIL,
    ESTADO TYPE OF COLUMN CONTACTOS_EMAIL.ESTADO,
...
BEGIN
     ...
     */
     ...
     IF((SELECT DISTINCT(1) FROM V_CATEGORIAS c WHERE c.ID = :I_ID_CATEGORIA AND c.ESTADO IS FALSE) = 1)THEN
...
GRANT EXECUTE
 ON PROCEDURE SP_DELETE_CATEGORIA TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_INSERT_CATEGORIA TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_I_CORREO TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_DIRECCION TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_DIRECCION TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_UPDATE_OR_INSERT_CORREO TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
