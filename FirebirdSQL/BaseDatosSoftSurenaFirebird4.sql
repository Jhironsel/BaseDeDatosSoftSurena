...
SET TERM ^ ;
CREATE PROCEDURE SP_D_CLIENTE_SB (
    V_ID TYPE OF COLUMN V_PERSONAS_CLIENTES.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_D_ESTUDIANTE (
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_CLIENTE_ID (
    I_ID TYPE OF COLUMN PERSONAS_CLIENTES.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_CLIENTE_SB (
    PERSONA TYPE OF COLUMN V_PERSONAS.PERSONA,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
    APELLIDOS TYPE OF COLUMN V_PERSONAS.APELLIDOS,
    SEXO TYPE OF COLUMN V_PERSONAS.SEXO,
    FECHA_NACIMIENTO TYPE OF COLUMN V_PERSONAS.FECHA_NACIMIENTO,
    ESTADO TYPE OF COLUMN V_PERSONAS.ESTADO,
    ESTADO_CIVIL TYPE OF COLUMN V_GENERALES.ESTADO_CIVIL )
RETURNS (
    V_ID TYPE OF COLUMN V_PERSONAS.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_PACIENTE (
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_PADRE_ESTUDIANTE (
    ID_HIJO TYPE OF COLUMN V_RELACION_PADRE_ESTUDIANTE.ID_ESTUDIANTE,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
    APELLIDOS TYPE OF COLUMN V_PERSONAS.APELLIDOS,
    ...
    ESTADO TYPE OF COLUMN V_PERSONAS.ESTADO )
RETURNS (
    O_ID TYPE OF COLUMN V_RELACION_PADRE_ESTUDIANTE.ID_PADRE_O_MADRE )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_I_PADRE_PACIENTE (
    ID_HIJO TYPE OF COLUMN V_RELACION_PADRE_ESTUDIANTE.ID_ESTUDIANTE,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
    ...
    ESTADO TYPE OF COLUMN V_PERSONAS.ESTADO )
RETURNS (
    O_ID TYPE OF COLUMN V_RELACION_PADRE_PACIENTE.ID_PADRE_O_MADRE )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_I_PERSONA (
    I_PERSONA TYPE OF COLUMN PERSONAS.PERSONA,
    I_PNOMBRE TYPE OF COLUMN PERSONAS.PNOMBRE,
    I_SNOMBRE TYPE OF COLUMN PERSONAS.SNOMBRE,
    I_APELLIDOS TYPE OF COLUMN PERSONAS.APELLIDOS,
    I_SEXO TYPE OF COLUMN PERSONAS.SEXO,
    I_FECHA_NACIMIENTO TYPE OF COLUMN PERSONAS.FECHA_NACIMIENTO,
    I_ESTADO TYPE OF COLUMN PERSONAS.ESTADO )
RETURNS (
    V_ID TYPE OF COLUMN PERSONAS.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_I_PROVEEDOR (
    ID_PROVINCIA TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_PROVINCIA,
    ID_MUNICIPIO TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_MUNICIPIO,
    PERSONA TYPE OF COLUMN V_PERSONAS.PERSONA,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
    APELLIDOS TYPE OF COLUMN V_PERSONAS.APELLIDOS,
    SEXO TYPE OF COLUMN V_PERSONAS.SEXO,
    DIRECCION TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.DIRECCION,
    ESTADO TYPE OF COLUMN V_PERSONAS.ESTADO,
    CODIGO_PROVEEDOR TYPE OF COLUMN V_PERSONAS_PROVEEDORES_ATR.CODIGO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
CREATE PROCEDURE SP_U_ANTECEDENTE (
    ...
    DESCRIPCION TYPE OF COLUMN ANTECEDENTES.ID )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
SET TERM ^ ;
CREATE PROCEDURE SP_U_CLIENTE_SB (
    ID TYPE OF COLUMN PERSONAS.ID,
...
SET TERM ^ ;
CREATE PROCEDURE SP_U_PACIENTE (
    ID_PACIENTE TYPE OF COLUMN PERSONAS.ID,
    PNOMBRE TYPE OF COLUMN PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN PERSONAS.SNOMBRE,
    APELLIDOS TYPE OF COLUMN PERSONAS.APELLIDOS,
    SEXO TYPE OF COLUMN PERSONAS.SEXO,
    ...
    ID_ARS TYPE OF COLUMN ASEGURADOS.ID_ARS,
    NO_NSS TYPE OF COLUMN ASEGURADOS.NO_NSS,
    ESTADO_ARS TYPE OF COLUMN ASEGURADOS.ESTADO )
SQL SECURITY DEFINER
AS 
BEGIN SUSPEND; 
END^
...
LEFT JOIN V_GENERALES g ON g.ID_PERSONA = r.ID
WHERE r.ID > 0 AND g.ID_PERSONA > 0;
CREATE VIEW GET_M_FACTURAS (ID, ID_CLIENTE, ID_CONTACTOS_TEL, ID_CONTACTOS_DIRECCIONES, ID_CONTACTOS_EMAIL, ID_TURNO, 
    FECHA_HORA, TOTAL, EFECTIVO, ESTADO_FACTURA, NOMBRE_TEMP, USER_NAME, PNOMBRE, SNOMBRE, APELLIDOS)
AS /*
...
*/;
CREATE VIEW GET_PACIENTES (ID, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, 
    FECHA_HORA_ULTIMO_UPDATE, ESTADO, PESO_NACIMIENTO_KG, ALTURA, PERIMETRO_CEFALICO, CESAREA, TIEMPO_GESTACION, 
    MASA_CEFALICA)
AS /*
...
CREATE VIEW GET_PROVEEDORES (ID, PERSONA, PNOMBRE, SNOMBRE, APELLIDOS, SEXO, ESTADO, CEDULA, ID_PERSONA, ID_PROVINCIA, 
...
FROM V_TANDAS t;
CREATE VIEW GET_TURNOS (ID, ID_ALMACEN, TURNO_USUARIO, FECHA_HORA_INICIO, FECHA_HORA_FINAL, ESTADO, MONTO_FACTURADO, 
    MONTO_DEVUELTO, MONTO_EFECTIVO, MONTO_CREDITO, NOMBRE_ALMACEN, ID_FACTURA)
AS /*
...
SELECT 
     ...
     ROL_USUARIO
FROM PERSONAS 
WHERE ID >= -1 OR ID IS NULL AND PERSONA IN ('X','J','F') AND SEXO IN('X','F','M')
WITH CHECK OPTION
/*
...
WHERE ID >= 0;
CREATE VIEW V_PERSONAS_PACIENTES_ATR (ID, PESO_NACIMIENTO_KG, ALTURA, PERIMETRO_CEFALICO, CESAREA, TIEMPO_GESTACION, 
    MASA_CEFALICA, USER_NAME)
AS /*
...
WHERE ID >= 0;
CREATE VIEW V_T_E_S_SYS (ID, NOMBRE_EMPRESA, FCHI, FCHA, FCHV, DIAS_RESTANTES, TELEFONO, DIRECCION, MENSAJE_FOOTER, LOGO
    )
AS /*
...
FROM T_MUNICIPIOS 
WHERE ID >= 0;
CREATE VIEW V_T_PLAN_CUENTA_CONTABLE (ID, PAIS, CODIGO_CUENTA_CONTABLE, NOMBRE_CUENTA, TIPO_CUENTA, NIVEL_CUENTA, 
...
BEGIN
    ...
    FOR SELECT ID FROM V_PERSONAS_CLIENTES WHERE ID != 0 INTO v_id DO BEGIN
        EXECUTE PROCEDURE SP_D_CLIENTE_SB(:v_id);
    END
    ...
    FOR SELECT ID_PERSONA FROM V_GENERALES INTO v_id DO BEGIN
    ...
    FOR SELECT ID FROM V_PERSONAS_ESTUDIANTES INTO v_id DO BEGIN
        EXECUTE PROCEDURE SP_D_ESTUDIANTE(:v_id);
    END
    ...
    DELETE FROM V_PERSONAS_CLIENTES_ATR;
    DELETE FROM V_PERSONAS_ESTUDIANTES_ATR;
    DELETE FROM V_PERSONAS_PACIENTES_ATR;
    DELETE FROM V_PERSONAS_PROVEEDORES_ATR;
    DELETE FROM V_PERSONAS_PROVEEDORES;
...
SET TERM ^ ;
ALTER PROCEDURE SP_D_CLIENTE_SB (
    V_ID TYPE OF COLUMN V_PERSONAS_CLIENTES.ID )
SQL SECURITY DEFINER
...
SET TERM ^ ;
ALTER PROCEDURE SP_D_ESTUDIANTE (
    V_ID TYPE OF COLUMN PERSONAS_ESTUDIANTES.ID )
SQL SECURITY DEFINER
...
SET TERM ^ ;
ALTER PROCEDURE SP_I_CLIENTE_ID (
    I_ID TYPE OF COLUMN PERSONAS_CLIENTES.ID )
SQL SECURITY DEFINER
...
BEGIN
     ...
     IF((SELECT DISTINCT (1) FROM V_PERSONAS c WHERE c.ID = :I_ID) IS NULL) THEN 
          EXCEPTION E_CLIENTE_NO_ENCONTRADO USING(:I_ID);
     
     IF((SELECT DISTINCT (1) FROM V_PERSONAS_CLIENTES c WHERE c.ID = :I_ID) IS NULL) THEN 
     BEGIN
          EXECUTE PROCEDURE SP_I_PERSONA_CLIENTE (:I_ID);
     END
...
COMMENT ON PROCEDURE SP_I_CLIENTE_SB IS 'Es el procedimiento utilizado para almacenar un cliente en el sb.';
SET TERM ^ ;
ALTER PROCEDURE SP_I_CLIENTE_SB (
    PERSONA TYPE OF COLUMN V_PERSONAS.PERSONA,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
...
BEGIN     
     V_ID = (SELECT V_ID
                FROM SP_I_PERSONA (:PERSONA, :PNOMBRE, :SNOMBRE, :APELLIDOS, :SEXO, :FECHA_NACIMIENTO, :ESTADO));
          
     EXECUTE PROCEDURE SP_I_PERSONA_CLIENTE (:V_ID);
     
     IF(:CEDULA <> NULL OR :CEDULA <> '000-0000000-0' OR :CEDULA <> '')THEN
     BEGIN
          EXECUTE PROCEDURE SP_I_GENERAL (:V_ID, :CEDULA, 0, :ESTADO_CIVIL);
     END
...
BEGIN    
    ...
    IF((SELECT DISTINCT (1) 
            ...
            V_ID = (SELECT MAX(c.ID)  FROM V_CONTACTOS_EMAIL c WHERE c.ID_PERSONA = :ID_PERSONA AND c.ESTADO OR c.ESTADO IS FALSE);
            
            if(V_ID IS NULL)THEN
                V_ID = (SELECT MAX(c.ID)  FROM V_CONTACTOS_EMAIL c WHERE c.ID_PERSONA = :ID_PERSONA  );
...
SET TERM ^ ;
ALTER PROCEDURE SP_I_PADRE_ESTUDIANTE (
    ID_HIJO TYPE OF COLUMN V_RELACION_PADRE_ESTUDIANTE.ID_ESTUDIANTE,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
...
BEGIN
     if((SELECT DISTINCT (1) 
            FROM V_GENERALES 
            WHERE CEDULA LIKE :CEDULA) IS NOT NULL) THEN
          EXCEPTION E_DUPLICADO_CEDULA;
     
     o_ID = (SELECT V_ID FROM SP_I_PERSONA ('F', :PNOMBRE, :SNOMBRE, :APELLIDOS, :SEXO, :FECHA_NACIMIENTO, :ESTADO));
     
     EXECUTE PROCEDURE SP_I_R_PADRE_ESTUDIANTE (:o_ID, :ID_HIJO);
     
     EXECUTE PROCEDURE SP_I_GENERAL (:O_ID, :CEDULA, :ID_TIPO_SANGRE, :ESTADO_CIVIL);
...
SET TERM ^ ;
ALTER PROCEDURE SP_I_PADRE_PACIENTE (
    ID_HIJO TYPE OF COLUMN V_RELACION_PADRE_ESTUDIANTE.ID_ESTUDIANTE,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN V_PERSONAS.PNOMBRE,
    SNOMBRE TYPE OF COLUMN V_PERSONAS.SNOMBRE,
...
BEGIN
     ...
     EXECUTE PROCEDURE SP_I_R_PADRE_PACIENTE(:o_ID, :ID_HIJO);
...
BEGIN
     ...
     VALUES ( NULL, :i_PERSONA, :i_PNOMBRE, :i_SNOMBRE, :i_APELLIDOS, :i_SEXO,:i_FECHA_NACIMIENTO, :i_ESTADO) 
     RETURNING ID
     INTO V_ID ;
...
SET TERM ^ ;
ALTER PROCEDURE SP_I_PROVEEDOR (
    ID_PROVINCIA TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_PROVINCIA,
    ID_MUNICIPIO TYPE OF COLUMN V_CONTACTOS_DIRECCIONES.ID_MUNICIPIO,
    PERSONA TYPE OF COLUMN V_PERSONAS.PERSONA,
    CEDULA TYPE OF COLUMN V_GENERALES.CEDULA,
...
AS
DECLARE VARIABLE V_ID TYPE OF COLUMN V_PERSONAS.ID;
BEGIN
     
     v_ID = (SELECT V_ID 
                FROM SP_I_PERSONA (:PERSONA, :PNOMBRE, :SNOMBRE, :APELLIDOS, :SEXO, '01.01.2000', :ESTADO)
                );
     
     EXECUTE PROCEDURE SP_I_GENERAL (:V_ID, :CEDULA, 0, 'X');
     
     --Direcion del proveedor.
     INSERT INTO V_CONTACTOS_DIRECCIONES (ID_PERSONA, ID_PROVINCIA, ID_MUNICIPIO, DIRECCION)
     VALUES (:V_ID, :id_provincia, :id_municipio, :direccion);
...
SET TERM ^ ;
ALTER PROCEDURE SP_U_CLIENTE_SB (
    ID TYPE OF COLUMN PERSONAS.ID,
    PERSONA TYPE OF COLUMN PERSONAS.PERSONA,
    CEDULA TYPE OF COLUMN GENERALES.CEDULA,
    PNOMBRE TYPE OF COLUMN PERSONAS.PNOMBRE,
...
AS
BEGIN
     IF((SELECT DISTINCT (1)  FROM V_PERSONAS_CLIENTES WHERE ID = :ID) IS NULL) THEN 
               EXCEPTION E_CLIENTE_NO_ENCONTRADO USING(:ID);
               
     IF(:ID = 0)THEN
          EXCEPTION E_CLIENTE_GENERICO;
          
     EXECUTE PROCEDURE SP_U_GENERAL (
            :ID, :CEDULA, 0, :ESTADO_CIVIL
    );
     
     EXECUTE PROCEDURE SP_U_PERSONA (
            :ID, :PERSONA, :PNOMBRE, :SNOMBRE, :APELLIDOS, :SEXO, :FECHA_NACIMIENTO, :ESTADO
    );
...
AS
--DECLARE VARIABLE V_ESTADO TYPE OF COLUMN 
BEGIN
     ...
     EXECUTE PROCEDURE SP_U_GENERAL (:ID_PACIENTE, :CEDULA, :ID_TIPO_SANGRE, 'X');
     
     EXECUTE PROCEDURE SP_U_ASEGURADO (:ID_PACIENTE, :ID_ARS, :NO_NSS, :ESTADO);
...
BEGIN
    --Verificando el codigo del cliente.
     IF((SELECT DISTINCT(1) 
          FROM V_PERSONAS
          WHERE ID = :ID_PERSONA) IS NULL OR  :ID_PERSONA = 0)THEN
...
GRANT EXECUTE
 ON PROCEDURE SP_D_CLIENTE_SB TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_D_CLIENTE_SB TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_D_ESTUDIANTE TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_D_ESTUDIANTE TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_I_CLIENTE_ID TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_CLIENTE_ID TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_CLIENTE_SB TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_CLIENTE_SB TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_I_PACIENTE TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_PACIENTE TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_PADRE_ESTUDIANTE TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_PADRE_ESTUDIANTE TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_PADRE_PACIENTE TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_PADRE_PACIENTE TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_I_PROVEEDOR TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_I_PROVEEDOR TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_U_CLIENTE_SB TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_U_CLIENTE_SB TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
...
GRANT EXECUTE
 ON PROCEDURE SP_U_PACIENTE TO ROLE RDB$ADMIN WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;

GRANT EXECUTE
 ON PROCEDURE SP_U_PACIENTE TO  SYSDBA WITH GRANT OPTION GRANTED BY SYSDBA                                                                                                                                                                                                                                                      ;
