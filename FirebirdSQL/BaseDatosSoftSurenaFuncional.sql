...
ALTER TABLE CONSULTAS_APROBADAS ADD TOTALCOSTO 
COMPUTED BY (CAST((costo - (costo * (descuento/100))) as D_DINERO));
...
FROM D_RECETAS 
WHERE ID_RECETA >= 0;
CREATE VIEW V_E_S_SYS (ID, NOMBRE_EMPRESA, FCHI, FCHA, FCHV, DIAS_RESTANTES, 
    TELEFONOS, DIRECCION, MENSAJE_FOOTER, LOGO)
AS /*
...
WHERE ID >= 0;
ALTER TABLE PERSONAS_PACIENTES_ATR ADD MASA_CEFALICA 
COMPUTED BY (CAST(PESO_NACIMIENTO_KG/(ALTURA*ALTURA) as D_MEDIDA));
...
*/;
CREATE VIEW GET_PACIENTES (ID, ID_ARS, NONSS, ID_TIPO_SANGRE, CEDULA, PNOMBRE, 
    SNOMBRE, APELLIDOS, SEXO, FECHA_NACIMIENTO, FECHA_INGRESO, 
...
CREATE VIEW GET_PERMISOS_ASIGNADOS (NOMBRE_RELACION, GRANT_OPTION, ID_TIPO_OBJ, 
    USUARIO, DESCRIPCION)
AS /*
...
CREATE VIEW GET_TEMPORALES (ID_FACTURA, NOMBRE_TEMP, PNOMBRE, SNOMBRE, 
    APELLIDOS, ID_TURNO, EFECTIVO, FECHA_HORA, ESTADO_FACTURA, ID_CLIENTE, 
    USER_NAME)
AS /*
